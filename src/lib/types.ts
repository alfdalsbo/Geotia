...
export type SlowGeoVariant = "slowgeo" | "bohemgeo";

export type SlowGeoUsedChallengeReason = "created" | "replaced" | "backfilled";
...
export type SlowGeoUsedChallenge = {
  candidateId: string;
  panoId?: string | null;
  roundId?: string | null;
  challengeId?: string | null;
  usedAt: string;
  reason: SlowGeoUsedChallengeReason;
};
